...
const Onboarding = require('../assets/images/icon.png'); //'https://images.unsplash.com/photo-1505995433366-e12047f3f144?fit=crop&w=840&q=80';
const MROLogo = require('../../assets/images/logo.png');
const TargetOnlineLogo = require('../../assets/images/Target-Online.png');
const loginBackground = require('../../assets/images/backgrounds/bg.png');
const photoPlaceHolder = require('../assets/images/faces/user.png');
