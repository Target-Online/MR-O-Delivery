...
class TextInput extends React.Component<Props>{ 
    ...
    render(){ 
        const {onChangeText, keyboardType, onClear, onBlur, value, clear, placeholder,error,label,password} = this.props
        ...
        return (  
            <View key={label} style={{height :  60, width : "100%",marginBottom : 4}}>
              <View style={[styles.textAreaStyles,styles.addressInputWrapper]} >               
                  ...
                  {(value !== null && value.length) ? <Btn onPress={()=>{ clear && onClear()}}> 
