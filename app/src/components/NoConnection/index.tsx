...
import { TouchableHighlight, View, Modal, Text, StyleSheet, Dimensions, ActivityIndicator } from 'react-native';
            ...
            >
                <View style={styles.wrapper}>
                    <Animatable.View duration={300} easing="ease-in" animation="fadeIn" style={styles.dialogContainer} >
                        ...
                        >
                            {loading ? <ActivityIndicator size="small" color={Colors.white} /> :<Text style={[styles.btnText,{color : "#fff"}]}>{"Reload"}</Text> }
                        </TouchableHighlight>
                     </Animatable.View>
                </View>
            </Modal>       
